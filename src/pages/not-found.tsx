            ...
            <div className="relative box-border flex min-h-screen flex-col content-stretch items-center gap-1 px-[20px] py-[4px] md:gap-2">
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-6 px-4 py-4 sm:gap-8 sm:px-6 sm:py-8">
                    <div className="text-center">
                        <div className="mb-4">
                            <span className="text-lg font-bold not-italic text-[#ff9b00] sm:text-[24px]">404 Error</span>
                        </div>
                        <h1 className="text-2xl font-bold not-italic leading-[normal] text-[#1c78bf] sm:text-[32px]">Page Not Found</h1>
                        <p className="mx-auto mt-4 max-w-md text-xs text-gray-600 sm:text-sm">Sorry, the page you are looking for doesn't exist or has been moved.</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        >
                            <span className="relative shrink-0 whitespace-pre text-nowrap text-lg font-bold not-italic leading-[normal] text-white sm:text-[20px]">
                                Home
                            </span>
                        </button>
                    </div>

                    <div className="relative flex shrink-0 flex-col content-stretch items-center gap-[16px] text-sm font-medium not-italic leading-[normal] text-[#1c78bf] sm:text-[16px]">
