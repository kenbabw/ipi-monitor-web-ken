                        ...
                        <div className="mb-2 sm:mb-3">
                            ...
                            <div className="flex w-full flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
                                ...
                                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                    <Button className="!bg-[rgb(156,163,175)] px-3 py-2 text-xs font-semibold text-white sm:px-4 sm:text-sm">
                                        Device Info
                                    </Button>
                                    <Button
                                        onClick={handleCharts}
                                        className="!bg-[rgb(255,155,0)] px-3 py-2 text-xs font-semibold text-white hover:!bg-[#1c78bf] sm:px-4 sm:text-sm"
                                    >
                                        Charts
                                    </Button>
                                    <Button
